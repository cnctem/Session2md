...
User and AI message bodies render as Markdown by default, including headings, lists, quotes, links, inline code, and fenced code blocks. Code blocks have their own copy button, while copying a message still preserves the original Markdown. Markdown rendering can be disabled under **Message Preview** in Settings.
